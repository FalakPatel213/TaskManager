...
import { Login as LoginIcon, Email, Person, DarkMode, LightMode } from '@mui/icons-material';
...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        if (userExists) {
            setSuccess(true);
            localStorage.setItem('currentUser', JSON.stringify({ username: username.trim(), email: email.trim() }));
            setTimeout(() => {
                setSuccess(false);
                navigate('/tasks');
            }, 1500);
            ...
            <Container maxWidth="sm">
                ...
                >
                    <Box sx={{ textAlign: 'center', mb: 4 }}>
                        <LoginIcon sx={{ fontSize: 60, color: '#6c5ce7', mb: 2 }} />
                        <Typography
                            variant="h4"
                            sx={{
